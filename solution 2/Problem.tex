...
don't.
			...
			By acting symmetrically Riley can border one of these areas. We know that $M~and~K$ are odd, then $\exists m, k: M = 2m+1\quad K = 2k+1$. Areas of the areas are $(2m+1)\cdot (k+1) ~~\&~~ (2k+1)\cdot (m+1)$, i.e. $2mk+k + 2m + 1~~\&~~ 2mk + m + 2k + 1$. $M\leqslant K\Rightarrow m\leqslant k\Rightarrow 2mk + m\leqslant 2m+k$, so Riley will choose to take one of  $2mk + k$ areas. %TODO rewrite  with right calculations
